    ...
    <DefaultField :field="field" :full-width-content="true">
        <template #field>
            <div class="w-full mb-4">
                <span class="ml-auto btn btn-primary btn-default mr-3 custom-button" @click="checkAll()">{{ __(field.translation_prefix + 'Select all')}}</span>
                ...
                >
                    ...
                    <div class="cursor-pointer flex items-center px-2 py-2 bg-40 rounded-lg" @click="showItem(group)">
                        <div class="w-full flex items-center">
                            <h3 class="capitalize flex-1">{{ field.translation_prefix + group }}</h3>
